        ...
        <div class="card card-flush bgi-no-repeat bgi-size-contain bgi-position-x-end h-md-50 mb-5 mb-xl-10" style="background-color: #3E97FF;background-image:url('{{ asset('keen') }}/media/svg/shapes/widget-bg-1.png')">
            ...
            <div class="card-header pt-5">
                ...
                <div class="card-title d-flex flex-column">
                    <!--begin::Amount-->
                    <span class="fs-2hx fw-bold text-white me-2 lh-1 ls-n2">{{$totalMeasurements}}</span>
                    <!--end::Amount-->
                    <!--begin::Subtitle-->
        ...
        <div class="card card-flush h-md-50 mb-5 mb-xl-10">
            ...
            <div class="card-header pt-5">
                ...
                <div class="card-title d-flex flex-column">
                    ...
                    <div class="d-flex align-items-center">
                        ...
                        <!--end::Currency-->
                        <!--begin::Amount-->
                        <span class="fs-2hx fw-bold text-dark me-2 lh-1 ls-n2">{{$costMeasurements}} / {{$totalMeasurements}} Properties</span>
                        <!--end::Amount-->
                        <!--begin::Badge-->
                        <!--end::Badge-->
                    </div>
                    <!--end::Info-->
                    <!--begin::Subtitle-->
                    <span class="text-gray-400 pt-1 fw-semibold fs-6">Total amount this year to date on measurements</span>
                    <!--end::Subtitle-->
                </div>
                <!--end::Title-->
            </div>
            ...
            <div class="card-body pt-2 pb-4 d-flex flex-wrap align-items-center">
                ...
                <div class="d-flex flex-column content-justify-center flex-row-fluid">
                    <!--begin::Label-->
                    @foreach( $allWorkers as $v )
                    <div class="d-flex fw-semibold align-items-center">
                        <!--begin::Bullet-->
                        <div class="bullet w-8px h-3px rounded-2 bg-success me-3"></div>
                        <!--end::Bullet-->
                        <!--begin::Label-->
                        <div class="text-gray-500 flex-grow-1 me-4">{{$v->name}}</div>
                        <!--end::Label-->
                        <!--begin::Stats-->
                        <div class="fw-bolder text-gray-700 text-xxl-end">${{$v->totalCost}} / {{$v->totalMeasurement}} Properties</div>
                        <!--end::Stats-->
                    </div>
                    @endforeach
                    <!--end::Label-->
